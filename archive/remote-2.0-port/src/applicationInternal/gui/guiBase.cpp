...
void init_gui(void) {
  ...
  // status bar
  init_gui_status_bar();
  // FPS counter and touch debug overlay (hidden by default, toggled from Settings)
  init_debugOverlay();
...
void gui_loop(void) {
  ...
  // fade out and hide aged touch trail dots, if the touch debug overlay is enabled
  debugOverlay_loop();
