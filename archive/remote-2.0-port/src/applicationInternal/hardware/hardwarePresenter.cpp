...
bool get_debugFPSEnabled() {
  return get_debugFPSEnabled_HAL();
}
void set_debugFPSEnabled(bool aDebugFPSEnabled) {
  set_debugFPSEnabled_HAL(aDebugFPSEnabled);
}
bool get_debugTouchEnabled() {
  return get_debugTouchEnabled_HAL();
}
void set_debugTouchEnabled(bool aDebugTouchEnabled) {
  set_debugTouchEnabled_HAL(aDebugTouchEnabled);
}
